...
INGREDIENT_PROMPT_GROUPS = {
    "Thịt bò": [
        ...
        "miếng thịt bò",
        "thịt bò",
        # THÊM MỚI để phân biệt với thịt lợn
        "beef with marbling",
        "red beef meat",
        "dark red beef",
        "raw beef slices",
        ...
        "a raw ingredient photo of beef",
        "bo",
        "thit bo",
        "thịt bò tươi",
        "thịt bò thái lát",
    ...
    "Thịt lợn": [
        ...
        "miếng thịt heo",
        "mieng thit heo",
        # THÊM MỚI để cải thiện - nhấn mạnh màu hồng nhạt
        "pink pork meat",
        "pale pork meat",
        ...
        "pinkish white pork",
        "light colored pork",
        "a photo of pale pork",
        "a photo of light pink pork",
        "thịt lợn màu hồng nhạt",
        "thịt heo màu hồng nhạt",
        "thit lon hong nhat",
    ],
    "Thịt gà": [
        "raw chicken",
        ...
        "a photo of raw chicken pieces",
        "a close-up photo of chicken",
        "thịt gà tươi",
        "thịt gà thái lát",
        "phi lê gà",
        "ức gà tươi",
    ...
    "Xúc xích": [
        ...
        "a photo of red sausages",
        "a food ingredient photo of sausage",
        "a food ingredient photo of hotdog",
        "xúc xích đỏ tươi",
        "xúc xích chín",
        "xuc xich chin",
    ],
    ...
    "Nấm": [
        ...
        "fresh mushrooms",
        "nấm",
        # Cải thiện - nhấn mạnh màu sắc và hình dạng
        "white mushroom",
        "button mushroom",
        "brown mushroom",
        "raw mushroom",
        ...
        "nấm trắng",
        "nấm nút",
        # Nhấn mạnh CAP STRUCTURE: brown/white cap with stem vs red round tomato
        "mushroom with brown cap",
        "mushroom with white cap",
        "mushroom with stem",
        "brown capped mushroom",
        "white capped mushroom",
        "dome shaped mushroom",
        ...
        "mushroom fungus",
        "edible mushroom",
        "a photo of mushroom caps",
        "a photo of whole mushroom",
        "a close-up of mushrooms",
        "nấm mũ nâu",
        "nấm có cuống",
        "nấm hình ô",
        # THÊM: emphasize NOT tomato
        "pale mushroom",
        "light brown mushroom",
        "cream mushroom",
        "beige capped mushroom",
        "mushroom on white background",
    ],
    "Đậu hũ": [
        "tofu",
        "tofu blocks",
        ...
        "đậu hũ",
        "đậu phụ",
        # Cải thiện - nhấn mạnh SOLID BLOCK shape
        "white tofu",
        "firm tofu",
        "tofu cubes",
        "fresh tofu",
        ...
        "miếng đậu hũ",
        "khối đậu hũ",
        # Nhấn mạnh SOLID BLOCK: rectangular solid vs liquid milk
        "solid tofu block",
        "firm tofu block",
        "square tofu",
        "rectangular tofu",
        ...
        "cubed tofu",
        "sliced tofu",
        "tofu with firm texture",
        "dense tofu block",
        "thick tofu block",
        "cut tofu block",
        "tofu on cutting board",
        "tofu on plate",
        "a photo of tofu block",
        "a photo of tofu chunk",
        "đậu hũ cứng",
        "đậu hũ thành khối",
        # THÊM: emphasize SOLID not LIQUID
        "solid white tofu",
        "firm white bean curd",
        "pressed tofu",
        "tofu slab",
        "tofu with edges",
        "tofu with corners",
    ...
    "Rau cải": [
        ...
        "rau cải",
        "cải xanh",
        # Cải thiện - nhấn mạnh GREEN LEAVES + WHITE STEMS
        "green bok choy",
        "chinese cabbage",
        "fresh bok choy",
        "raw bok choy",
        ...
        "rau cải tươi",
        "cải bẹ xanh",
        # Nhấn mạnh LEAFY STRUCTURE: green leaves with white stems
        "bok choy with white stems",
        "bok choy with green leaves",
        "green and white bok choy",
        "leafy green bok choy",
        "fresh green bok choy",
        "bunch of bok choy",
        "bok choy leaves",
        "bok choy bunch",
        "green leafy bok choy",
        "a photo of green bok choy",
        "a photo of bok choy leaves",
        "a close-up of bok choy",
        "rau cải lá xanh",
        "bó rau cải",
        "lá rau cải",
        # THÊM: emphasize GREEN LEAFY vs other vegetables
        "dark green bok choy",
        "bright green bok choy",
        "bok choy vegetable",
        "chinese green vegetable",
        "asian leafy green",
        "green vegetable with white stem",
        "leafy vegetable",
    ],
    "Cơm": [
        "rice",
        ...
        "cơm trắng",
        "cơm",
        # Cải thiện - nhấn mạnh COOKED GRAINS IN BOWL
        "cooked rice",
        "bowl of white rice",
        "rice in bowl",
        "steamed white rice",
        ...
        "a photo of steamed rice",
        "com",
        "bát cơm",
        "cơm trong bát",
        # Nhấn mạnh TEXTURE: soft wet grains vs dry solid potato
        "soft wet rice",
        "moist rice grains",
        "individual rice grains",
        "small white rice grains",
        "separated rice grains",
        "tiny white grains",
        "soft rice texture",
        "wet cooked rice",
        "sticky white rice",
        "fluffy white rice",
        "a photo of rice grains",
        "a photo of soft rice",
        "a close-up of rice",
        "cơm hạt mềm",
        "hạt cơm nhỏ",
        "cơm mềm ẩm",
        # THÊM: context và color distinction
        "white rice on plate",
        "plain white rice",
        "jasmine rice",
        "cooked white grain",
    ...
    "Cá": [
        ...
        "a photo of raw fish",
        "a raw ingredient photo of fish",
        "a food ingredient photo of fish",
        "ca",
        "cá trắng",
        "phi lê cá trắng",
        "thịt cá trắng",
    ...
    "Yến mạch": [
        ...
        "oat flakes",
        "yến mạch",
        # THÊM MỚI để phân biệt rõ với Cơm
        "oat grains",
        "whole oats",
        "raw oats",
        "uncooked oats",
        ...
        "a raw ingredient photo of oats",
        "a food ingredient photo of oats",
    ...
    "Bí đỏ": [
        ...
        # Distinctive visual characteristics (NOT like sweet potato/carrot)
        "pumpkin with hard orange skin",
        "pumpkin with thick rind",
        "orange pumpkin with green stem",
        "whole round pumpkin",
        "large round orange pumpkin",
        "pumpkin with ribbed surface",
        "pumpkin with seeds inside",
        "pumpkin cavity with seeds",
        "hollow pumpkin interior",
        
        # Cooked/cut pumpkin (emphasize texture difference)
        "pumpkin pieces with skin",
        "pumpkin chunks with hard skin",
        "cubed pumpkin with rind",
        "pumpkin slices with rind",
        "pumpkin wedges",
        "thick pumpkin chunks",
                ...
                for sp in site_packages:
                    ...
                    if torch_lib.exists():
                        if hasattr(os, 'add_dll_directory'):
                            ...
                            logger.info("[PYTORCH DLL FIX] Added to PATH: %s", torch_lib)
                        break
